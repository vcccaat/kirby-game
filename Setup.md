## Setup for Assignment 2 should be the same as it was for Assignment 1. The text below is copied from A1 for your reference.
...
For more details on assignment 1, check out the [./README.md](./README.md).
